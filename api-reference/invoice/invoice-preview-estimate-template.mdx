...
<ParamField query="templateId" type="string" required default='5f9d6d8b1b2d2c001f2d9e4b'>
Template Id
</ParamField>
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/invoices/estimate/template/preview' \
  -H 'Authorization: Bearer YOUR_TOKEN' \
  -H 'Version: 2021-07-28'
```

```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/invoices/estimate/template/preview', {
  method: 'GET',
  headers: {
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/invoices/estimate/template/preview');
