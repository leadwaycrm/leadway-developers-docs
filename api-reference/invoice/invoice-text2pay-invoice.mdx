...
<ParamField body="includeTermsNote" type="boolean" default='True'>
include terms & notes with receipts
</ParamField>

<ParamField body="action" type="string" required default='draft'>
...
<ResponseField name="invoiceUrl" type="string" required>
