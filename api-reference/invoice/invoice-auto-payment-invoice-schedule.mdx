...
<ParamField body="autoPayment" type="object" required>
...
```bash cURL
curl -X POST 'https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/auto-payment' \
...
```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/auto-payment', {
  method: 'POST',
  headers: {
  ...
  body: JSON.stringify({"altId": "6578278e879ad2646715ba9c", "altType": "account", "id": "string"}),
});
...
response = requests.request(
    'POST',
    'https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/auto-payment',
    headers={
        'Authorization': f"Bearer {os.environ['LEADWAY_TOKEN']}",
        'Version': '2021-07-28',
        'Content-Type': 'application/json',
    },
    json={"altId": "6578278e879ad2646715ba9c", "altType": "account", "id": "string"},
)
data = response.json()
```
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/auto-payment');
curl_setopt_array($ch, [
    ...
    CURLOPT_POSTFIELDS => json_encode({'altId': '6578278e879ad2646715ba9c', 'altType': 'account', 'id': 'string'}),
]);
