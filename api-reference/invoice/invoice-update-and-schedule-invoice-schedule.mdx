...
```bash cURL
curl -X POST 'https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/updateAndSchedule' \
  -H 'Authorization: Bearer YOUR_TOKEN' \
  -H 'Version: 2021-07-28'
```

```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/updateAndSchedule', {
  method: 'POST',
  headers: {
...
response = requests.request(
    'POST',
    'https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/updateAndSchedule',
    headers={
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/updateAndSchedule');
