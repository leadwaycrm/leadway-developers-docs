...
<ParamField body="lateFeesConfiguration" type="object" required>
...
```bash cURL
curl -X PATCH 'https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/late-fees-configuration' \
...
```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/late-fees-configuration', {
  method: 'PATCH',
  headers: {
...
response = requests.request(
    'PATCH',
    'https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/late-fees-configuration',
    headers={
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/late-fees-configuration');
