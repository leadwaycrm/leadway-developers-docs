...
```bash cURL
curl -X POST 'https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/cancel' \
...
```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/cancel', {
  method: 'POST',
  headers: {
...
response = requests.request(
    'POST',
    'https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/cancel',
    headers={
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/invoices/schedule/YOUR_scheduleId/cancel');
