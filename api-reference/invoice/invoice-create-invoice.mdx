...
<ParamField body="dueDate" type="string" default='2023-01-14'>
Due date in YYYY-MM-DD format
</ParamField>

<ParamField body="sentTo" type="object" required>
<Expandable title="propiedades">
