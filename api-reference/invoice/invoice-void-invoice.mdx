...
```bash cURL
curl -X POST 'https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/void' \
...
```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/void', {
  method: 'POST',
  headers: {
...
response = requests.request(
    'POST',
    'https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/void',
    headers={
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/invoices/YOUR_invoiceId/void');
