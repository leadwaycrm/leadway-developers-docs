...
```http
GET https://services.leadconnectorhq.com/ad-publishing/google/ad-accounts/{adAccountId}
```
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/ad-publishing/google/ad-accounts/YOUR_adAccountId' \
