...
description: 'Retrieve the Google Ads integration details for a account'
---

Retrieve the Google Ads integration details for a account

```http
GET https://services.leadconnectorhq.com/ad-publishing/google/integration
```
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/ad-publishing/google/integration' \
