...
<ParamField body="contactId" type="string" required default='0007BWpSzSwfiuSl0tR2'>
Contact Id
</ParamField>

<ParamField body="startTime" type="string" required default='2021-06-23T03:30:00+05:30'>
Start Time
</ParamField>
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/calendars/events/appointments');
