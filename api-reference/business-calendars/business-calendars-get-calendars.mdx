---
title: 'Get Calendars'
description: 'Get all calendars in a account.'
---
...
<ParamField query="groupId" type="string" default='BqTwX8QFwXzpegMve9EQ'>
Group Id
</ParamField>

<ParamField query="showDrafted" type="boolean" default='False'>
Show drafted
</ParamField>
