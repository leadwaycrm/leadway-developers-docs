---
title: 'Get Contacts'
description: 'Get Contacts   **Note:** This API endpoint is deprecated. Please use the Search Contacts endpoint instead.'
---
...
<ParamField query="startAfter" type="number" default='1603870249758'>
Start Afte
</ParamField>
