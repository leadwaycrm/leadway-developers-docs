...
<ResponseField name="message" type="string" required default='Fetched LinkedIn Account'>
Message
</ResponseField>
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/social-media-posting/oauth/YOUR_locationId/linkedin/accounts/YOUR_accountId' \
