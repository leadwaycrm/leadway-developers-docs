...
description: 'Get google business accounts'
---
...
<ResponseField name="message" type="string" required default='Fetched Google Business Account'>
Message
</ResponseField>
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/social-media-posting/oauth/YOUR_locationId/google/locations/YOUR_accountId' \
