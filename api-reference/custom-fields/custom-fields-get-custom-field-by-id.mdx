...
description: '<div>                   <p> Get Custom Field / Folder By Id.</p>                    <div>                     <span style= "display: inline-block;                                 width: 25px; height: '
---
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/custom-fields/YOUR_id' \
