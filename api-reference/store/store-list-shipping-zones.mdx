...
<ParamField query="withShippingRate" type="boolean" default='True'>
...
<ResponseField name="countries" type="object[]" required>
List of countries that are available
<Expandable title="cada item">
<ResponseField name="code" type="number" required default='US'>
...
<Expandable title="cada item">
<ResponseField name="code" type="string" required default='VA'>
