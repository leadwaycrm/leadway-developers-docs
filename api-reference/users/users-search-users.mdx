...
<ParamField query="companyId" type="string" required default='5DP41231LkQsiKESj6rh'>
...
<ParamField query="skip" type="string" default='1'>
...
<ParamField query="locationId" type="string" default='5DP41231LkQsiKESj6rh'>
Account ID in which the search needs to be performed
</ParamField>

<ParamField query="type" type="string" default='agency'>
Type of the users to be filtered in the search
</ParamField>

<ParamField query="role" type="string" default='admin'>
Role of the users to be filtered in the search
</ParamField>

<ParamField query="ids" type="string" default='5DP4iH6HLkQsiKESj6rh,5DP4iH6HLkQsiKESj34h'>
List of User IDs to be filtered in the search
</ParamField>

<ParamField query="sort" type="string" default='dateAdded'>
...
<ParamField query="enabled2waySync" type="boolean">
</ParamField>
...
```bash cURL
curl -X GET 'https://services.leadconnectorhq.com/users/search' \
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/users/search');
