...
description: '**Deprecated endpoint - use GET /agent instead.**  Lists all active agents that have a published production version for the specified account. locationId is required parameter. Supports pagination usi'
---

**Deprecated endpoint - use GET /agent instead.**

Lists all active agents that have a published production version for the specified account. locationId is required parameter. Supports pagination using limit and offset.
