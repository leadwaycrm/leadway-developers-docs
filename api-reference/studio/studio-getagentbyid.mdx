---
title: 'Get Agent'
description: 'Gets a specific agent by its ID for the specified account with all its versions. Returns complete agent metadata and all non-deleted versions (draft, staging, production). locationId is required param'
---
