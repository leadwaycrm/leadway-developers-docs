...
description: '**Deprecated endpoint - use POST /agent/:agentId/execute instead.**  Executes the specified agent and returns a non-streaming JSON response with the complete agent output. The agent must be in active '
---
...
```javascript Node.js
const response = await fetch('https://services.leadconnectorhq.com/agent-studio/public-api/agents/YOUR_agentId/execute', {
  method: 'POST',
  headers: {
...
response = requests.request(
    'POST',
    'https://services.leadconnectorhq.com/agent-studio/public-api/agents/YOUR_agentId/execute',
    headers={
...
```php PHP
<?php
$ch = curl_init('https://services.leadconnectorhq.com/agent-studio/public-api/agents/YOUR_agentId/execute');
